...
const CustomTabsPill = styled(Tabs)(({
  size
}) => {
  let height = '60px';
...
const CustomTabDefault = styled(Tab)(({
  theme
}) => ({
  '&.MuiTab-root': {
    fontFamily: '"Open Sans", sans-serif',
...
const CustomTabFill = styled(Tab)(({
  theme
}) => ({
  '&.MuiTab-root': {
    fontFamily: '"Open Sans", sans-serif',
...
const CustomTabPill = styled(Tab)(({
  size
}) => {
  let height = '50px';
...
export { Requirements, TabCustomRandom, TabsComponent };
